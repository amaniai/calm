from calm.dsl.builtins import Substrate, readiness_probe, read_provider_spec, action, CalmTask


class OracleEraSubstrate(Substrate):

    os_type = 'Linux'
    provider_type = 'EXISTING_VM'
    provider_spec = read_provider_spec('specs/oracle_era.yaml')
    ...
    def __pre_create__(self):
        CalmTask.SetVariable.escript(filename='scripts/era_set_credentials.py', name='set era credentials',
                                     variables=['ERA_USERNAME', 'ERA_PASSWORD'])
